 ...
 */
public class OrgnizationLifeAty extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        simple_Adapter = new SimpleAdapter(this,getData(), R.layout.pty_org_life_item_with_pic,new String[]{"org_pic","org_tittle","org_text","org_num","org_time"},new int[]{R.id.org_life_pic,R.id.org_life_title,R.id.org_life_text,R.id.org_life_num,R.id.org_life_time});
